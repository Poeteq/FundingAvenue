...
{
    public class ExcelBusinessHelper
    {
        public static ExcelWorksheet BuildBusinessProfile(ExcelWorksheet ws, ApplicationForm form)
        {
            // ********
            // SECTION: CORPORATION
            // CORP >>
            ...
            ws.Cells["K32"].Value = form.ApplicationType;
